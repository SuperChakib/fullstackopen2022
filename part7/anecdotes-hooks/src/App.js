...
const App = () => {
  ...
  const vote = (id) => {
    ...
    setAnecdotes(anecdotes.map(anecdote => anecdote.id === id ? votedAnecdote : anecdote))
  }
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/anecdotes/:id' element={<Anecdote anecdote={matchedAnecdote} vote={vote} />}></Route>
