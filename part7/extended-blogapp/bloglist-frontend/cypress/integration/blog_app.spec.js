  ...
  describe('When logged in', function () {
    ...
    it('A blog can be created', function () {
      ...
      cy.get('.blogItem')
        ...
        .and('contain', 'Chakib')
      cy.get('.blogDetails').should('contain', 'chakib.first-blog.com')
    })

    describe('and multiple blogs saved', function () {
      beforeEach(function () {
        cy.createBlog({
          title: '1 like at beginning',
          author: 'Chakib',
          url: 'chakib.first-blog.com',
          likes: 1,
        })
        cy.createBlog({
          title: '2 likes at beginning',
          author: 'Chakib',
          url: 'chakib.second-blog.com',
          likes: 2,
        })
        cy.createBlog({
          title: '0 likes at beginning',
          author: 'Chakib',
          url: 'chakib.third-blog.com',
          likes: 0,
        })

        cy.contains('0 likes at beginning').as('blogHeader')
        cy.get('@blogHeader').find('button').click()
      })
      ...
      it('users can delete own blogs', function () {
        cy.get('@blogHeader').parent().contains('button', 'remove').click()
